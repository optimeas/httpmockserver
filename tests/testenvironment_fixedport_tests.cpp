...
int main(int argc, char *argv[])
{
    ...
    ::testing::Environment * const env = ::testing::AddGlobalTestEnvironment(new httpmock::TestEnvironment(61381));
